          ...
          <ScrollAnimation direction="right" className="order-1 lg:order-2">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 mb-6">
                Notre chambre De Luxe offre un espace élégant et confortable avec un lit double et des équipements
                modernes. Décorée avec soin, cette chambre dispose d'une télévision à écran plat, d'un coin salon avec
                fauteuil en rotin, et de tout le nécessaire pour un séjour agréable et relaxant.
              </p>
            ...
            <TabsContent value="description" className="mt-6">
              <ScrollAnimation delay={0.1}>
                <div className="space-y-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <p>
                    Notre chambre De Luxe est l'option idéale pour les voyageurs exigeants. Avec ses 25m², elle offre un
                    espace confortable et élégant pour vous détendre après une journée de voyage ou de travail.
                  </p>
                  <p>
                    La chambre est équipée d'un lit double confortable avec un matelas de qualité supérieure et du linge
                    de lit doux en coton pour garantir une nuit reposante. La décoration soignée et les tons clairs

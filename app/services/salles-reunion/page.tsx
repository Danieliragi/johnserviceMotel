              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-gray-700">
                    Notre équipe dédiée vous accompagne dans l&apos;organisation de votre événement, de la réservation à
                    la mise en place, en passant par la restauration et les services annexes.
                  </p>
                </div>
                <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
                  <OptimizedImage src="/motel-day-1.jpeg" alt="Salle de réunion moderne" fill className="object-cover" />
                </div>
              </div>
            </ScrollAnimation>
          </div>
            ...
            <ScrollAnimation>
              ...
              <Tabs defaultValue="boardroom" className="w-full">
                ...
                <TabsContent value="boardroom" className="border rounded-lg p-6 bg-white shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        Notre salle de conseil est idéale pour les réunions de direction, les entretiens ou les petites
                        réunions d&apos;équipe. Avec sa table centrale et ses fauteuils confortables, elle offre un cadre
                        professionnel et intimiste.
                      </p>
                ...
                <TabsContent value="conference" className="border rounded-lg p-6 bg-white shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="relative h-[300px] rounded-lg overflow-hidden">
                      <OptimizedImage src="/motel-day-1.jpeg" alt="Salle de conférence" fill className="object-cover" />
                    </div>
                    <div>
                ...
                <TabsContent value="workshop" className="border rounded-lg p-6 bg-white shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-4">
                        Notre espace atelier est conçu pour favoriser la créativité et la collaboration. Idéal pour les
                        sessions de brainstorming, les ateliers de travail ou les formations interactives.
                      </p>
                      <ul className="space-y-2 mb-6">
                        <li className="flex items-center">
                          <span className="mr-2">✓</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-gray-700">
                      Nous proposons des tarifs préférentiels pour l&apos;hébergement des participants à votre événement
                      dans notre motel, avec des chambres confortables et modernes.
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="bg-white shadow-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 mb-4 italic">
                      "Nous avons organisé notre séminaire annuel au John Services Motel et tout était parfait. Les salles
                      sont spacieuses et bien équipées, le service est impeccable et la restauration excellente. Nous
                ...
                <Card className="bg-white shadow-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 mb-4 italic">
                      "Nous avons organisé un atelier de formation dans l'espace atelier et c'était parfait. L'espace est
                      lumineux, le mobilier modulable nous a permis d'adapter la salle à nos besoins. Le service de
                      restauration était excellent."
                    </p>
                    <div className="flex items-center">
                      <div className="mr-4">
                        <div className="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto text-center">
            <ScrollAnimation>
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
                Contactez-nous dès maintenant pour discuter de votre projet et obtenir un devis personnalisé. Notre équipe

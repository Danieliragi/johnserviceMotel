                ...
                <TabsContent value="breakfast" className="border rounded-lg p-6 bg-white shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="relative h-[400px] rounded-lg overflow-hidden">
                      <OptimizedImage src="/motel-restaurant.jpeg" alt="Petit-déjeuner" fill className="object-cover" />
                    </div>
                  </div>
                </TabsContent>
            ...
            <ScrollAnimation>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl order-2 md:order-1">
                  <OptimizedImage
                    src="/motel-bar.jpeg"
                    alt="Bar du John Services Motel"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="order-1 md:order-2">
                  <h2 className="text-3xl font-bold mb-6">Notre Bar</h2>
                  <p className="text-gray-700 mb-4">
                    Détendez-vous dans notre bar élégant et confortable, l&apos;endroit idéal pour savourer un cocktail,
                    un verre de vin ou une bière artisanale après une journée bien remplie.
                  </p>
                  <p className="text-gray-700 mb-4">
                    Notre barman talentueux vous propose une sélection de cocktails classiques et créations originales,
                    ainsi qu&apos;une carte des vins soigneusement élaborée pour satisfaire tous les goûts.
                  </p>
                  <p className="text-gray-700 mb-6">
                    Le bar est ouvert tous les jours de 17h à minuit, avec une happy hour de 18h à 20h.
                  </p>
                  <Button asChild>
                    <Link href="/contact">Réserver une table</Link>
                  </Button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-gray-700">
                      Nous proposons des options végétariennes, véganes et sans gluten pour répondre à tous les régimes
          ...
          <div className="max-w-7xl mx-auto text-center">
            <ScrollAnimation>
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
                Pour une expérience culinaire inoubliable, réservez votre table dès maintenant. Notre équipe se fera un
